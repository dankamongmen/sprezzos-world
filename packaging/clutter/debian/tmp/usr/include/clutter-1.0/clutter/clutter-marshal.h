...
/* BOOLEAN:STRING,UINT,FLAGS (./clutter-marshal.list:7) */
...
/* BOOLEAN:OBJECT (./clutter-marshal.list:8) */
...
/* BOOLEAN:OBJECT,FLOAT,FLOAT (./clutter-marshal.list:9) */
...
/* BOXED:UINT,UINT (./clutter-marshal.list:10) */
...
/* DOUBLE:VOID (./clutter-marshal.list:11) */
...
/* UINT:VOID (./clutter-marshal.list:12) */
...
/* VOID:INT (./clutter-marshal.list:16) */
#define _clutter_marshal_VOID__INT	g_cclosure_marshal_VOID__INT

/* VOID:INT64,INT64,FLOAT,BOOLEAN (./clutter-marshal.list:17) */
...
/* VOID:INT,INT (./clutter-marshal.list:18) */
...
/* VOID:FLOAT,FLOAT (./clutter-marshal.list:19) */
...
/* VOID:INT,INT,INT,INT (./clutter-marshal.list:20) */
...
/* VOID:OBJECT (./clutter-marshal.list:21) */
#define _clutter_marshal_VOID__OBJECT	g_cclosure_marshal_VOID__OBJECT

/* VOID:OBJECT,FLAGS (./clutter-marshal.list:22) */
...
/* VOID:OBJECT,FLOAT,FLOAT (./clutter-marshal.list:23) */
...
/* VOID:OBJECT,FLOAT,FLOAT,FLAGS (./clutter-marshal.list:24) */
...
/* VOID:OBJECT,PARAM (./clutter-marshal.list:25) */
...
/* VOID:OBJECT,POINTER (./clutter-marshal.list:26) */
...
/* VOID:OBJECT,UINT (./clutter-marshal.list:27) */
...
/* VOID:POINTER (./clutter-marshal.list:28) */
#define _clutter_marshal_VOID__POINTER	g_cclosure_marshal_VOID__POINTER

/* VOID:STRING,BOOLEAN (./clutter-marshal.list:29) */
...
/* VOID:STRING,BOOLEAN,BOOLEAN (./clutter-marshal.list:30) */
...
/* VOID:STRING,INT (./clutter-marshal.list:31) */
...
/* VOID:UINT (./clutter-marshal.list:32) */
#define _clutter_marshal_VOID__UINT	g_cclosure_marshal_VOID__UINT

/* VOID:UINT,STRING,UINT (./clutter-marshal.list:33) */
...
/* VOID:UINT,UINT (./clutter-marshal.list:34) */
...
/* VOID:VOID (./clutter-marshal.list:35) */
#define _clutter_marshal_VOID__VOID	g_cclosure_marshal_VOID__VOID

/* VOID:STRING,INT,POINTER (./clutter-marshal.list:36) */
