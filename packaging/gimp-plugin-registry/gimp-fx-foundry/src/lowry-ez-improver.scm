...
(define (script-fu-EZImprover  img drawable merge-flag )
   ...
   (gimp-drawable-set-name sat-layer _"Merge this layer down second")
   ...
   (if (equal? merge-flag TRUE)
       ...
       (gimp-drawable-set-name second-merge _"Fixed with EZ Improver")
...
(script-fu-register "script-fu-EZImprover"
      _"EZ Improver"
      _"Add screen layer and a saturation layer. Works best on photos described as 'dingy' or 'dull'."
      "Mark Lowry"
