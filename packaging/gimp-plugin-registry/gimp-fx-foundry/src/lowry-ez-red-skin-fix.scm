...
(define (script-fu-EZRedSkinFix  img drawable opacity merge-flag )
   ...
   (gimp-drawable-set-name screen-layer _"Adjust opacity, then merge this layer down first")
   ...
   (gimp-drawable-set-name value-layer _"Merge this layer down second")
   ...
   (if (equal? merge-flag TRUE)
       ...
       (gimp-drawable-set-name second-merge _"Fixed with EZ Red Skin Fix")
...
(script-fu-register "script-fu-EZRedSkinFix"
      _"EZ Red Skin Fix"
      _"Add screen layer and a value layer.  Adjust layer opacities to suit."
      "Mark Lowry"
      ...
      SF-ADJUSTMENT _"Strength? (Screen Layer Opacity)"  '(35 0 100 1 10 0 0)
